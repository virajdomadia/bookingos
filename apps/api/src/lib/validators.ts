...
// "YYYY-MM-DD" calendar day in the tenant timezone. We reject malformed strings
// here and verify it is a real date (e.g. not 2026-02-30) in the route.
const isoDate = z
  .string()
...
export const bookingCreateSchema = z.object({
  ...
  date: isoDate,
  // "HH:MM" wall-clock slot start in the tenant timezone.
  time: z
    .string()
    .regex(/^([01][0-9]|2[0-3]):[0-5][0-9]$/, "Invalid time"),
